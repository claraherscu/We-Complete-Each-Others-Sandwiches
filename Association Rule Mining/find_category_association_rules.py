...
with open('C:\\Users\\Daniel\\PycharmProjects\\SpiceItUp\\itemsets\\soups_stews_chili\\itemsets_size_1.pickle', 'wb') as f:
    pickle.dump(frequent_ingredients_1, f)
with open('C:\\Users\\Daniel\\PycharmProjects\\SpiceItUp\\itemsets\\soups_stews_chili\\itemsets_size_2.pickle', 'wb') as f:
    pickle.dump(frequent_ingredients_2, f)
with open('C:\\Users\\Daniel\\PycharmProjects\\SpiceItUp\\itemsets\\soups_stews_chili\\itemsets_size_3.pickle', 'wb') as f:
    pickle.dump(frequent_ingredients_3, f)
with open('C:\\Users\\Daniel\\PycharmProjects\\SpiceItUp\\itemsets\\soups_stews_chili\\itemsets_size_4.pickle', 'wb') as f:
...
with open('C:\\Users\\Daniel\\PycharmProjects\\SpiceItUp\\association rules\\soups_stews_chili_association_rules.json', 'w') as json_file:
